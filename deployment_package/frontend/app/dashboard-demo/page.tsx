      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            🚀 Дашборд администратора v3
          </h1>
          <p className="text-xl text-gray-600">
            Полноценная панель управления системой
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <a href="/admin/logs" className="p-4 rounded-lg border border-gray-200 hover:shadow-md transition-shadow duration-200 group">
              <div className="flex items-center space-x-3">
                <div className="p-2 rounded-lg bg-green-500 text-white">
                  <span className="text-xl">📋</span>
                </div>
                <div>
                  <h4 className="font-medium text-gray-900 group-hover:text-blue-600">Системные логи</h4>
                  <p className="text-sm text-gray-600">Просмотр логов и событий</p>
                </div>
              </div>
            </a>

            <a href="/admin/backup" className="p-4 rounded-lg border border-gray-200 hover:shadow-md transition-shadow duration-200 group">
              <div className="flex items-center space-x-3">
                <div className="p-2 rounded-lg bg-purple-500 text-white">
                  <span className="text-xl">💾</span>
                </div>
                <div>
                  <h4 className="font-medium text-gray-900 group-hover:text-blue-600">Резервные копии</h4>
                  <p className="text-sm text-gray-600">Управление бэкапами</p>
                </div>
              </div>
            </a>

            <a href="/admin/analytics" className="p-4 rounded-lg border border-gray-200 hover:shadow-md transition-shadow duration-200 group">
              <div className="flex items-center space-x-3">
                <div className="p-2 rounded-lg bg-orange-500 text-white">
                  <span className="text-xl">📊</span>
                </div>
                <div>
                  <h4 className="font-medium text-gray-900 group-hover:text-blue-600">Аналитика</h4>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Публикация новости</p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-xs text-gray-500">2025-09-27 19:42:30</p>
                <p className="text-xs text-gray-500">192.168.1.103</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">admin</p>
                  <p className="text-xs text-gray-600">Изменение настроек</p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-xs text-gray-500">2025-09-27 19:41:15</p>
                <p className="text-xs text-gray-500">192.168.1.100</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-center">
            ...
            <div>
              <h4 className="text-blue-800 font-medium">Информация о системе</h4>
              <p className="text-blue-600 text-sm">
                Дашборд администратора v3 успешно реализован и готов к использованию. 
                Все компоненты работают корректно, API v3 доступен по адресу /api/v3/.
              </p>
            </div>
          </div>
        </div>
