...
# Запуск backend с минимальными зависимостями
# Использование: ./minimal-backend.sh

set -e

echo "🚀 Запуск Backend с минимальными зависимостями"
echo "============================================="
...
# Проверяем наличие requirements-minimal.txt
if [ ! -f "requirements-minimal.txt" ]; then
    echo "❌ Не удалось найти requirements-minimal.txt!"
    exit 1
fi
