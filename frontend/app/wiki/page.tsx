            ...
            <div className="space-y-6">
              ...
              <div>
                <ProcessGraph
                  ...
                  nodes={[
                    { id: 'start', title: 'Начало', type: 'start', x: 100, y: 150 },
                    { id: 'register', title: 'Регистрация', type: 'process', x: 300, y: 150 },
                    { id: 'verify', title: 'Проверка данных', type: 'decision', x: 500, y: 150 },
                    { id: 'activate', title: 'Активация', type: 'process', x: 700, y: 80 },
                    { id: 'assign_role', title: 'Назначение роли', type: 'process', x: 700, y: 220 },
                    { id: 'end', title: 'Завершение', type: 'end', x: 900, y: 150 }
                  ]}
                  connections={[
              ...
              <div>
                <ProcessGraph
                  ...
                  nodes={[
                    { id: 'trigger', title: 'Триггер', type: 'start', x: 100, y: 150 },
                    { id: 'webhook', title: 'Webhook', type: 'process', x: 300, y: 150 },
                    { id: 'process_data', title: 'Обработка данных', type: 'process', x: 500, y: 150 },
                    { id: 'decision', title: 'Условие', type: 'decision', x: 700, y: 150 },
                    { id: 'send_email', title: 'Отправка email', type: 'process', x: 900, y: 80 },
                    { id: 'update_db', title: 'Обновление БД', type: 'process', x: 900, y: 220 },
                    { id: 'end', title: 'Завершение', type: 'end', x: 1100, y: 150 }
                  ]}
                  connections={[
              ...
              <div>
                <ProcessGraph
                  ...
                  nodes={[
                    { id: 'init', title: 'Инициация', type: 'start', x: 100, y: 150 },
                    { id: 'plan', title: 'Планирование', type: 'process', x: 300, y: 150 },
                    { id: 'assign', title: 'Назначение', type: 'process', x: 500, y: 150 },
                    { id: 'execute', title: 'Выполнение', type: 'process', x: 700, y: 150 },
                    { id: 'monitor', title: 'Контроль', type: 'decision', x: 900, y: 150 },
                    { id: 'complete', title: 'Завершение', type: 'process', x: 1100, y: 80 },
                    { id: 'review', title: 'Доработка', type: 'process', x: 1100, y: 220 },
                    { id: 'close', title: 'Закрытие', type: 'end', x: 1300, y: 150 }
                  ]}
                  connections={[
                    { from: 'init', to: 'plan' },
                    { from: 'plan', to: 'assign' },
