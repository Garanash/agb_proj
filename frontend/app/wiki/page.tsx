              ...
              <div>
                <ProcessGraph
                  ...
                  nodes={[
                    ...
                    { id: 'plan', title: 'Планирование', type: 'process', x: 200, y: 150 },
                    { id: 'assign', title: 'Назначение', type: 'process', x: 320, y: 150 },
                    { id: 'execute', title: 'Выполнение', type: 'process', x: 440, y: 150 },
                    { id: 'monitor', title: 'Контроль', type: 'decision', x: 560, y: 150 },
                    { id: 'complete', title: 'Завершение', type: 'process', x: 680, y: 100 },
                    { id: 'review', title: 'Доработка', type: 'process', x: 680, y: 200 },
                    { id: 'close', title: 'Закрытие', type: 'end', x: 800, y: 150 }
                  ]}
                  connections={[
                    { from: 'init', to: 'plan' },
                    { from: 'plan', to: 'assign' },
